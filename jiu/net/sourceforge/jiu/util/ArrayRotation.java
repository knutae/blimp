...
public class ArrayRotation
{
	...
	{
		//System.out.println("90 left (to copy) width=" + width + " height=" + height + " dest.length=" + dest.length);
	...
	{
		//System.out.println("90 left in-place");
	...
	{
		//System.out.println("90 right in-place (empty)");
