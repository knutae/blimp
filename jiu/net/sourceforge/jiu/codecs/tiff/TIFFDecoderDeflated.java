 ...
 * class which does most of the use.
 * All the decoder has to do is feed it with compressed data from the input file.
 * and give decompressed data received from the Inflater to the putBytes method.
...
public class TIFFDecoderDeflated extends TIFFDecoder
{
	...
	{
		return new Integer[] {new Integer(TIFFConstants.COMPRESSION_DEFLATED_INOFFICIAL), new Integer(TIFFConstants.COMPRESSION_DEFLATED_OFFICIAL)};
	}
