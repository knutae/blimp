		...
		WrongParameterException
	{
		...
		if (input instanceof RGB24Image) {
			...
			for (int y = 0; y < height; y++) {
				input24.getByteSamples(RGBIndex.INDEX_RED, 0, y, width, 1, redLine, 0);
				input24.getByteSamples(RGBIndex.INDEX_GREEN, 0, y, width, 1, greenLine, 0);
				input24.getByteSamples(RGBIndex.INDEX_BLUE, 0, y, width, 1, blueLine, 0);
				...
				output24.putByteSamples(RGBIndex.INDEX_RED, 0, y, width, 1, grayLine, 0);
				output24.putByteSamples(RGBIndex.INDEX_GREEN, 0, y, width, 1, grayLine, 0);
				output24.putByteSamples(RGBIndex.INDEX_BLUE, 0, y, width, 1, grayLine, 0);
			...
			for (int y = 0; y < height; y++) {
				input48.getShortSamples(RGBIndex.INDEX_RED, 0, y, width, 1, redLine, 0);
				input48.getShortSamples(RGBIndex.INDEX_GREEN, 0, y, width, 1, greenLine, 0);
				input48.getShortSamples(RGBIndex.INDEX_BLUE, 0, y, width, 1, blueLine, 0);
				...
				output48.putShortSamples(RGBIndex.INDEX_RED, 0, y, width, 1, grayLine, 0);
				output48.putShortSamples(RGBIndex.INDEX_GREEN, 0, y, width, 1, grayLine, 0);
				output48.putShortSamples(RGBIndex.INDEX_BLUE, 0, y, width, 1, grayLine, 0);
