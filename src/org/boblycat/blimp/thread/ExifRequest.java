...
public class ExifRequest extends Request {
    ...
    ExifRequest(ImageWorkerThread thread, Object owner, BlimpSession session, ExifQueryTask task) {
    ...
    protected void execute() throws IOException {
        ...
        exifTask.data = thread.getSession().getInterestingExifData();
        thread.asyncExec(exifTask);
    }
}